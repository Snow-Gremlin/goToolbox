...
func Test_Predicate_EpsilonEq(t *testing.T) {
	p := EpsilonEq(5.0, .2)
	checkPred(t, p, 4.0, false)
	checkPred(t, p, 4.7, false)
	checkPred(t, p, 4.9, true)
	checkPred(t, p, 5.0, true)
	checkPred(t, p, 5.1, true)
	checkPred(t, p, 5.3, false)
	checkPred(t, p, 6.0, false)
}
