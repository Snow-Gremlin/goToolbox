...
// EpsilonEq is a predicate which returns true if the value passed
// into the predicate is within an epsilon value (inclusively)
// of the other value. This is useful for finding floating-point
// values which have lost precision via calculations and will
// not be equal a literal, but will be very close to it.
func EpsilonEq[T utils.FloatingConstraint](value, epsilon T) collections.Predicate[T] {
