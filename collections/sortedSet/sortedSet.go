...
func New[T any](comparer ...comp.Comparer[T]) collections.Set[T] {
...
func CapNew[T any](capacity int, comparer ...comp.Comparer[T]) collections.Set[T] {
...
func With[T any](s []T, comparer ...comp.Comparer[T]) collections.Set[T] {
...
func From[T any](e collections.Enumerator[T], comparer ...comp.Comparer[T]) collections.Set[T] {
...
func CapFrom[T any](e collections.Enumerator[T], capacity int, comparer ...comp.Comparer[T]) collections.Set[T] {
