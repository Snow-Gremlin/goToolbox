...
func New[T any](comparer ...utils.Comparer[T]) collections.Set[T] {
...
func CapNew[T any](capacity int, comparer ...utils.Comparer[T]) collections.Set[T] {
...
func With[T any](s []T, comparer ...utils.Comparer[T]) collections.Set[T] {
...
func From[T any](e collections.Enumerator[T], comparer ...utils.Comparer[T]) collections.Set[T] {
...
func CapFrom[T any](e collections.Enumerator[T], capacity int, comparer ...utils.Comparer[T]) collections.Set[T] {
